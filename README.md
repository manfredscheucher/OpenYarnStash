...
**OpenYarnStash** is an open-source app for managing your yarn stash and knitting projects. 
...
OpenYarnStash is built with [Kotlin Multiplatform](https://en.wikipedia.org/wiki/Kotlin_(programming_language)#Multiplatform) and [Compose Multiplatform](https://www.jetbrains.com/compose-multiplatform/), 
