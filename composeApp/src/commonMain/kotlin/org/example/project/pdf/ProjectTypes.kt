...
data class Project(val id: Int, val title: String, val imageIds: List<Int>)
data class Params(val gauge: String?, val needles: String?, val size: String?, val yarnWeight: String?, val notes: String?)
data class Yarn(val id: Int, val brand: String?, val name: String?, val colorway: String?, val lot: String?, val material: String?, val weightClass: String?, val imageIds: List<Int>)
