...
val LocalDesktopBackHandler = compositionLocalOf<((Boolean, () -> Unit) -> Unit)?> { null }
...
fun App(
    ...
    settingsManager: JsonSettingsManager,
    fileDownloader: FileDownloader,
    fileHandler: FileHandler,
    setDesktopBackHandler: ((Boolean, () -> Unit) -> Unit)? = null
) {
    ...
    CompositionLocalProvider(LocalDesktopBackHandler provides setDesktopBackHandler) {
        MaterialTheme(
